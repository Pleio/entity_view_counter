...
echo "<div>";
	echo elgg_echo("entity_view_counter:settings:ignore_ips") . ":";
	echo elgg_view("input/text", array("name" => "params[ignore_ips]", "value" => $plugin->ignore_ips));
	echo "<div class='elgg-subtext'>" .
		elgg_echo("entity_view_counter:settings:ignore_ips:description") .
	"</div>";
echo "</div>";